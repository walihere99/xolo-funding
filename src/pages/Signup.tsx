...
import { Mail, Lock, User, ArrowRight, Github, ShieldCheck, ChevronDown, Eye, EyeOff, AlertCircle } from 'lucide-react';
        ...
        >
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            <div className="flex gap-4 mb-2">
              <button type="button" className="flex-1 flex items-center justify-center gap-3 py-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 transition-all text-sm font-medium">
